    ...
    <script>
        ...
        $(document).ready(function() {
            $('.form-penjualan').on('submit', function(e) {
                ...
                // Ambil nilai total dan diterima
                let total = parseFloat($('#total').val()) || 0; // Ambil nilai dari input hidden 'total'
                let diterima = parseFloat($('#diterima').val()) || 0; // Ambil nilai dari input 'diterima'

                // Validasi jika total lebih besar dari diterima
                if (total > diterima) {
                    alert('Peringatan: Jumlah yang diterima tidak mencukupi untuk total pembayaran!');
                    return; // Berhenti, form tidak dikirim
                }

                // Jika validasi lolos, lanjutkan AJAX
